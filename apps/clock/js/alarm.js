...
var ClockView = {
  ...
  init: function cv_init() {
    ...
    this.digitalClock.className = ''; /* hide difital */
    this.analogClock.className = ''; /* hide difital */
  ...
  updateAnalogClock: function cv_updateAnalogClock() {
    ...
    var last_hour = (now.getHours()-1 % 12) + min / 60;
    ...
    this.setTransform('hourhand', hour * 30 - 180, (last_hour) * 30 - 180); // 30 degrees per hour
...
var AlarmManager = {
  ...
  init: function am_init() {
    var self = this;
    navigator.mozSetMessageHandler && navigator.mozSetMessageHandler('alarm', function gotMessage(message) {
